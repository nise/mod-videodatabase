...
require_capability('mod/videodatabase:video-manager', $context);
...
/*********/
$PAGE->set_url('/mod/videodatabase/video-manager.php', array('id' => $cm->id));
...
$PAGE->requires->js_call_amd('mod_videodatabase/videodatabase','init', $data);
